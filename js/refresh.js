...
function ref_Memory() {
   var get_Mem = $.get('API/memory.php',function(result){ document.getElementById("Memory_Status").innerHTML = result + "%" + " of " + document.getElementById("j_Server_Installed_Memory").innerHTML + "KB" });
}
